          ...
          >
            <MC.CardActionArea>
              <MC.CardMedia
                ...
                image={student.profile.ProfilePhoto}
              ...
              <MC.CardContent>
                ...
                <MC.Typography
                  ...
                  component="p"
                >
                  Year: {student.Year} Section: {student.profile.Section} ID:{" "}
                  {student.profile.ID} <br />
                  At {student.profile.Department} Department
                  <br />
                </MC.Typography>
              </MC.CardContent>
            </MC.CardActionArea>
            <MC.CardActions>
              ...
              <MC.Button size="small" color="primary"
              >
                View Attendance
              </MC.Button>
            </MC.CardActions>
